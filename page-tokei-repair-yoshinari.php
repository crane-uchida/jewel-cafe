...
$shop_name = 'ジュエルカフェ 鳥取吉成店';
$shop_tel = '0857-51-7085';
...
<div class="breadcrumbs">
    <div class="section-inner" style="font-size:12px;">
        ...
        <a href="https://jewel-cafe.jp/shop/chugoku/tottori/">鳥取県<span></span></a>鳥取吉成店
    </div>
</div>
</div>
...
<div class="kind-of-repair-wrap">
	<div class="inner">
		<h1>鳥取市吉成の腕時計の修理・オーバーホール・電池交換工房</h1>
	...
	<div class="store-map">
		...
		<div class="map">
			...
			<script>
				...
				const address = "〒680-0864 鳥取県鳥取市吉成779-41 日本海ビルⅡ101号室";
				const shopname = "鳥取吉成店";
...
<div class="band-wrap">
	<div class="inner">
		<p class="txt01">受付店舗は鳥取県鳥取市にございます。<br>来店ご予約受付中！</p>
		<div class="box">
