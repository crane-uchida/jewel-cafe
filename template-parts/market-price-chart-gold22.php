...
<section class="gold-info mb-40">
    <div class="common-ttl">
        <div class="section-inner">
						<h2 class="kaitori-title">
							<span class="common-ttl-sub">本日の金・貴金属</span>
    ...
    <div class="section-inner">
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "インゴット(金)価格相場",
                        lineTension: 0,
                        data: <?php echo $marketPrice->chart_data('gold', true, 'インゴット (金)'); ?>,
                        backgroundColor: [
                            'rgba(255, 99, 132, .1)',
                        ],
                        borderColor: [
        ...
        <div class="table ta-c">
            <table>
                ...
                <tbody>
                    <?php $compare = $marketPrice->get('c_gold'); ?>
                    <tr>
                        <td>
                            <div class="ta-l"><a href="#">インゴット(金)</a></div>
                        </td>
                        <td>
                            <div class="bold">¥<?php echo $marketPrice->get('gold'); ?></div>
                        </td>
                        <td>
                    ...
                    ?>
                    <?php foreach ($gold_types as $d => $v): ?>
                        <?php $compare = number_format($marketPrice->get('c_gold', false) * $marketPrice->ratio['k' . $d]); ?>
                        <tr>
                            <td>
                                <div class="ta-l"><a class="fc_blue" href="#"><?php echo $d; ?>金 (<?php echo $d; ?>K)</a></div>
                            </td>
                            <td>
                                <div class="bold">¥<?php echo $marketPrice->get('k' . $d); ?></div>
                            </td>
                            <td>
                                <div class="base-font-size">(<?php echo ($compare >= 0 ? '+' : '') . $compare; ?><span>円</span>)</div>
                            </td>
