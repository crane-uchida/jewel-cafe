<?php
	...
	$hinmoku_term_slug = $hinmoku_term[0]->slug;
	$hinmoku_post = get_page_by_path( $hinmoku_term_slug, OBJECT, 'kaitori' );
...
<section class="tokei-pricetable mb-40">
	<div class="common-ttl">
		<div class="section-inner">
			<h2 class="shop-title kaitori-title">
				<span class="common-ttl-sub">ジュエルカフェ<?php echo esc_html($child_term_name);?> - <?php echo esc_html(get_post( $parent_id )->post_title);?></span>
				<span class="common-ttl-main"><?php echo esc_html($hinmoku_term[0]->name);?>価格<span class="color-red">相場表</span></span>
			</h2>
							...
							<div class="model-content">
								<table>
									<?php
										...
										if(get_post($post->post_parent)->post_name== 'rolex-top'){
